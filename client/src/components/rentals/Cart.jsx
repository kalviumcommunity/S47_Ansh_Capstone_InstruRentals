...
const Cart = () => {
    ...
    const handleCheckout = async () => {
        ...
        try {
            const res = await axios.post("https://s47-ansh-capstone-instrurentals-3.onrender.com/api/payment/order", { amount, currency, receipt: receiptId });
 ...
 // Assuming each item has an '_id' field representing its ObjectId
            ...
            const options = {
                ...
                "handler": async function (response) {
                    ...
                    const validated = await axios.post("https://s47-ansh-capstone-instrurentals-3.onrender.com/api/payment/order/validate", response);
                    console.log(validated.data);


                    await axios.post("https://s47-ansh-capstone-instrurentals-3.onrender.com/api/user/orders", {
                        userId,
                        items,
                        quantity,
                        totalPrice
